...
final class HomeViewController: UIViewController, AlertDisplaying {
    ...
    func locationSetting() {
        ...
        self.mainView.mapView.setRegion(MKCoordinateRegion(center: sesacCampusCoordinate, span: MKCoordinateSpan(latitudeDelta: 0.01, longitudeDelta: 0.01)), animated: true)
        self.mainView.mapView.delegate = self
        self.mainView.mapView.register(CustomAnnotationView.self, forAnnotationViewWithReuseIdentifier: CustomAnnotationView.identifier)
    }
    ...
    @objc func floatingButtonClicked() {
        ...
        if try! viewModel.user.value().gender == Gender.none.rawValue {
            ...
            let viewController = MainViewController()//HomeHobbyViewController()
    ...
    func searchNearFriends() {
        let onQueueDTO = OnQueueDTO(region: viewModel.region.value, lat: viewModel.latitude.value, long: viewModel.longitude.value)
...
extension HomeViewController: CLLocationManagerDelegate {
    ...
    func checkCurrentLocationAuthorization(_ authorizationStatus: CLAuthorizationStatus) {
        ...
        case .restricted, .denied:
            ...
            viewModel.calculateRegion(latitude: sesacCampusCoordinate.latitude, longitude: sesacCampusCoordinate.longitude)
    ...
    func presentSetting() {
        ...
        displayAlertWithAction(title: "위치 권한 요청", message: "위치 서비스 사용 불가") { action in
...
extension HomeViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        guard let customAnnotationView = mainView.mapView.dequeueReusableAnnotationView(withIdentifier: CustomAnnotationView.identifier) else {
